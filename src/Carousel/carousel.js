...
dots.forEach((dot, index3) => {
    dot.addEventListener("click", () => {
        ...
        img_c3.style.opacity = 0.7;
        setTimeout(() => {
            img_c3.setAttribute(
                "src",
                `./assets/Images/img-${index3 + 1}.avif`
            );
            img_c3.style.opacity = 1;
        }, 500);
    });
});
